...
CPURV64::CPURV64(sc_core::sc_module_name const& name, BaseType PC, bool debug) : CPU(name, debug), INSTR(0) {
...
void CPURV64::call_interrupt(tlm::tlm_generic_payload& m_trans, sc_core::sc_time& delay) {
    interrupt = true;
