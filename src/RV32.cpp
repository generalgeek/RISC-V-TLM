...
CPURV32::CPURV32(sc_core::sc_module_name const& name, BaseType PC, bool debug) : CPU(name, debug), INSTR(0) {
    ...
    instr_bus.register_invalidate_direct_mem_ptr(this, &CPURV32::invalidate_direct_mem_ptr);
...
void CPURV32::call_interrupt(tlm::tlm_generic_payload& m_trans, sc_core::sc_time& delay) {
    interrupt = true;
