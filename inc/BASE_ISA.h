 ...
 */
template <typename T> class BASE_ISA : public extension_base<T> {
  public:
    /**
     ...
     * @return funct7 field
     */
    inline std::uint32_t get_funct7() const { return this->m_instr.range(31, 25); }
     ...
     */
    inline unsigned_T get_imm_U() const { return this->m_instr.range(31, 12); }
     ...
     */
    inline unsigned_T get_shamt() const { return this->m_instr.range(25, 20); }

    /**
     * @brief Returns CSR field for CSR instructions
     * @return value corresponding to instr(31:20)
     */
    inline unsigned_T get_csr() const { return this->m_instr.range(31, 20); }

    /**
     * @brief Access to opcode field
     * @return return opcode field
     */
    inline unsigned_T opcode() const override { return this->m_instr.range(6, 0); }
    ...
    bool Exec_AUIPC() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. AUIPC: x{:d} <- 0x{:x} + PC (0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rd, imm, new_pc);
    ...
    bool Exec_JAL() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. JAL: x{:d} <- 0x{:x}. PC + 0x{:x} -> PC (0x{:x})",
                            sc_core::sc_time_stamp().value(), old_pc - 4, rd, old_pc, mem_addr, new_pc);
    ...
    bool Exec_JALR() const {
        ...
        this->regs->setPC(new_pc);
        this->logger->debug("{} ns. PC: 0x{:x}. JALR: x{:d} <- 0x{:x}. PC <- 0x{:x}", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_BEQ() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. BEQ: x{:d}(0x{:x}) == x{:d}(0x{:x})? -> PC (0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, this->regs->getValue(rs1), rs2,
                            this->regs->getValue(rs2), this->regs->getPC());
    ...
    bool Exec_BNE() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. BNE: x{:d}(0x{:x}) != x{:d}(0x{:x})? -> PC (0x{:x})",
                            sc_core::sc_time_stamp().value(), old_pc, rs1, val1, rs2, val2, this->regs->getPC());
    ...
    bool Exec_BLT() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. BLT: x{:d}(0x{:x}) < x{:d}(0x{:x})? -> PC (0x{:x})",
                            sc_core::sc_time_stamp().value(), old_pc, rs1, this->regs->getValue(rs1), rs2,
                            this->regs->getValue(rs2), this->regs->getPC());
    ...
    bool Exec_LB() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. LB: x{:d} + x{:d}(0x{:x}) -> x{:d}", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, imm, mem_addr, rd);
    ...
    bool Exec_LH() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. LH: x{:d} + x{:d}(0x{:x}) -> x{:d}", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, imm, mem_addr, rd);
    ...
    bool Exec_LW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. LW: x{:d} + x{:d}(0x{:x}) -> x{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, imm, mem_addr, rd, data);
    ...
    bool Exec_LD() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. LD: 0x{:x}({:d}) + {:d}(0x{:x}) -> x{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, offset, imm, mem_addr, rd,
                            data);
        return true;
    }
    ...
    bool Exec_SD() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SD: 0x{:x} -> x{:d} + 0x{:x}(@0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs2, rs1, imm, mem_addr);
    ...
    bool Exec_SB() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SB: x{:d} -> x{:d} + 0x{:x}(@0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs2, rs1, imm, mem_addr);
    ...
    bool Exec_SH() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SH: x{:d} -> x{:d} + 0x{:x}(@0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs2, rs1, imm, mem_addr);
    ...
    bool Exec_SW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SW: x{:d}(0x{:x}) -> x{:d} + 0x{:x}(@0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs2, data, rs1, imm, mem_addr);
    ...
    bool Exec_ADDI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. ADDI: x{:d}(0x{:x}) + {:d} -> x{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, this->regs->getValue(rs1), imm,
                            rd, calc);
    ...
    bool Exec_ADDIW() const {
        ...
        this->regs->setValue(rd, calc);
        this->logger->debug("{} ns. PC: 0x{:x}. ADDIW: x{:d} + {:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_SLTI() const {
        ...
        if (val1 < imm) {
            ...
            this->logger->debug("{} ns. PC: 0x{:x}. SLTI: x{:d} < x{:d} => 1 -> x{:d}",
                                sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, imm, rd);
        } else {
    ...
    bool Exec_ANDI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. ANDI: x{:d} AND 0x{:x} -> x{:d}", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, imm, rd);
    ...
    bool Exec_SLLIW() {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SLLIW: x{:d} << {:d} -> x{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, shift, rd, calc);
    ...
    bool Exec_ADDW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. ADDW: x{:d} + x{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_SUBW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SUBW: x{:d} + x{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_SRLW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SRLW: x{:d} >> {:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, shift, rd, calc);
    ...
    bool Exec_SRAW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SRAW: x{:d} >> {:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, shift, rd, calc);
    ...
    bool Exec_ADD() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. ADD: x{:d} + x{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_SUB() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. SUB: x{:d} - x{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_SLT() const {
        ...
        if (val1 < val2) {
            this->regs->setValue(rd, 1);
            this->logger->debug("{} ns. PC: 0x{:x}. SLT: x{:d} < x{:d} => 1 -> x{:d}", sc_core::sc_time_stamp().value(),
                                this->regs->getPC(), rs1, rs2, rd);
        } else {
            this->regs->setValue(rd, 0);
            this->logger->debug("{} ns. PC: 0x{:x}. SLT: x{:d} < x{:d} => 0 -> x{:d}", sc_core::sc_time_stamp().value(),
                                this->regs->getPC(), rs1, rs2, rd);
        }
    ...
    bool Exec_SLTU() const {
        ...
        if (val1 < val2) {
            ...
            this->logger->debug("{} ns. PC: 0x{:x}. SLTU: x{:d} < x{:d} => 1 -> x{:d}",
                                sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, rs2, rd);
        } else {
            this->regs->setValue(rd, 0);
    ...
    bool Exec_XOR() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. XOR: x{:d} XOR x{:d} -> x{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_OR() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. OR: x{:d} OR x{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_ECALL() {
        ...
        std::cout << std::endl << "ECALL Instruction called, stopping simulation" << std::endl;
        this->regs->dump();
    ...
    bool Exec_EBREAK() {
        ...
        std::cout << std::endl << "EBRAK  Instruction called, dumping information" << std::endl;
        this->regs->dump();
        std::cout << "Simulation time " << sc_core::sc_time_stamp() << "\n";
        this->perf->dump();
    ...
    bool Exec_CSRRW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. CSRRW: CSR #{:d} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), csr, rd, aux);
    ...
    bool Exec_CSRRS() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. CSRRS: CSR #{:d}(0x{:x}) -> x{:d}(0x{:x}) & CSR #{:d} <- 0x{:x}",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), csr, aux, rd, rs1, csr, aux2);
    ...
    bool Exec_CSRRWI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. CSRRWI: CSR #{:d} -> x{:d}. x{:d} -> CSR #{:d}",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), csr, rd, rs1, csr);
    ...
    bool Exec_CSRRSI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. CSRRSI: CSR #{:d} -> x{:d}. x{:d} & CSR #{:d}(0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), csr, rd, rs1, csr, aux);
