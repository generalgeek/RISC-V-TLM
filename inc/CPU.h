...
class CPU : sc_core::sc_module {
  public:
     ...
     */
    virtual void call_interrupt(tlm::tlm_generic_payload& trans, sc_core::sc_time& delay) = 0;
...
class CPURV32 : public CPU {
  ...
  private:
     ...
     * it triggers an IRQ when called
     */
    void call_interrupt(tlm::tlm_generic_payload& trans, sc_core::sc_time& delay) override;
