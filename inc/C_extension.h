 ...
 */
template <typename T> class C_extension : public extension_base<T> {
  public:
    /**
    ...
    inline void set_rs1(std::uint32_t value) override { this->m_instr.range(11, 7) = value; }
    ...
    inline void set_rs2(std::uint32_t value) override { this->m_instr.range(6, 2) = value; }
    ...
    inline void set_funct3(std::uint32_t value) override { this->m_instr.range(15, 13) = value; }
    ...
    inline void set_imm_I(std::uint32_t value) const { this->m_instr.range(31, 20) = value; }
    ...
    inline void set_imm_U(std::uint32_t value) const { this->m_instr.range(31, 12) = (value << 12); }
    ...
    [[nodiscard]] inline std::uint32_t get_csr() const { return get_imm_I(); }
    ...
    bool Exec_C_JR() const {
        ...
        new_pc = static_cast<unsigned_T>(
            static_cast<unsigned_T>((this->regs->getValue(rs1)) + static_cast<unsigned_T>(mem_addr)) & 0xFFFFFFFE);
    ...
    bool Exec_C_MV() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.MV: x{:d}(0x{:x}) -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs2, this->regs->getValue(rs2), rd, calc);
    ...
    bool Exec_C_ADD() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.ADD: x{:d} + x{} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_C_ADDI16SP() const {
        ...
        if (this->get_rd() == 2) {
            ...
            this->logger->debug("{} ns. PC: 0x{:x}. C.ADDI16SP: x{:d} + {:d} -> x{:d} (0x{:x})",
                                sc_core::sc_time_stamp().value(), this->regs->getPC(), rs1, imm, rd, calc);
        } else {
            /* C.LUI OPCODE */
            rd = this->get_rd();
            imm = get_imm_LUI();
    ...
    bool Exec_C_BEQZ() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.BEQZ: x{:d}(0x{:x}) == 0? -> PC (0xx{:d})",
                            sc_core::sc_time_stamp().value(), old_pc, rs1, val1, new_pc);
    ...
    bool Exec_C_SRAI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.SRAI: x{:d} >> {} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_C_SLLI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.SLLI: x{:d} << {} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, shift, rd, calc);
    ...
    bool Exec_C_ANDI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. ANDI: x{:d} C.AND 0x{:x} -> x{:d}", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_C_ADDW() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.ADDW: x{:d} + x{} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, rs2, rd, calc);
    ...
    bool Exec_C_ADDI() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.ADDI: x{:d} + {} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
    ...
    bool Exec_C_ADDIW() const {
        ...
        this->regs->setValue(rd, calc);
        this->logger->debug("{} ns. PC: 0x{:x}. C.ADDIW: x{:d} + {} -> x{:d}(0x{:x})", sc_core::sc_time_stamp().value(),
                            this->regs->getPC(), rs1, imm, rd, calc);
    ...
    bool Exec_C_JALR() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.JALR: x{:d} <- 0x{:x} PC <- 0xx{:x}",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), rd, old_pc + 4, new_pc);
    ...
    bool Exec_C_LDSP() const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.LDSP: x{:d}(0x{:x}) -> x{:d} + 0x{:x}(@0x{:x})",
                            sc_core::sc_time_stamp().value(), this->regs->getPC(), 2, data, rs1, imm, mem_addr);
        return true;
    }
    ...
    bool Exec_C_JAL(int m_rd) const {
        ...
        this->logger->debug("{} ns. PC: 0x{:x}. C.JAL: x{:d} <- 0x{:x}. PC + 0x{:x} -> PC (0x{:x})",
                            sc_core::sc_time_stamp().value(), old_pc - 2, rd, old_pc, mem_addr, new_pc);
    ...
    bool Exec_C_EBREAK() {
        ...
        std::cout << std::endl << "C.EBRAK  Instruction called, dumping information" << std::endl;
        this->regs->dump();
